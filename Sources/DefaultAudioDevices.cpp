...
const std::string DefaultAudioDevices::DEFAULT_INPUT_ID("com.fredemmott.sdmute.deviceIds.defaultInput");
const std::string DefaultAudioDevices::DEFAULT_OUTPUT_ID("com.fredemmott.sdmute.deviceIds.defaultOutput");
